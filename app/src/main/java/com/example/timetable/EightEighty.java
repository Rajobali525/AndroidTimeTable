...
public class EightEighty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eight_eighty);
//       ration = findViewById(R.id.ed11);
...
//                    tv1.setText("Total Runnint Time :" + totalrunning);
                    ...
                    if ((ln.equals(65)||ln.equals(64)||ln.equals(66)) && dld > ld) {
                        ...
                        w6 = w4 % 60;
                        lp1 = dld-ld;
                        lpr = Math.ceil((8.0 / 80.0) * lp1 * km);
                        dr = Math.ceil((w4 * 20.0) / 60);
                        sr = Math.ceil((ts * 30.0) / 60);
                        tr = Math.ceil(ration + sr + dr + lpr);
                        tv2.setText(String.valueOf("R/T  " + runninth + " : " + runningm +  " Ration " + ration + " load  " +dld  ));
                        ...
                        w6 = w4 % 60;
                        lp1 =  ld-dld;
                        lpr = Math.floor((6.0 / 80.0) * lp1 * km);
                        dr = Math.ceil((w4 * 20.0) / 60);
                        sr = Math.ceil((ts * 30.0) / 60);
                        tr = Math.ceil(ration + sr + dr - lpr);
